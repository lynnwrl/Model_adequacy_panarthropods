...
model <- "MkV+G"
dataset <- "Yang2016.nex"
analysis_name <- "pps_morpho_arthropods_Yang"
...
for (i in 1:length(sim_reps)){
  ...
  par(mfrow=c(2,2))
  hist(TestStats[,"Consistency Index"], col = "gray74", border = "white", xlim = c(0.34,0.85), 
  ...
  hist(TestStats[,"Retention Index"],  col = "gray74", border = "white", xlim = c(0.63,1), 
