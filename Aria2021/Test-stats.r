...
model <- "MkV+G"
dataset <- "Aria2021.nex"
analysis_name <- "pps_morpho_arthropods_Aria"
...
for (i in 1:length(sim_reps)){
  ...
  par(mfrow=c(2,2))
  hist(TestStats[,"Consistency Index"], col = "gray74", border = "white", xlim = c(0.18,0.56), 
  ...
  hist(TestStats[,"Retention Index"],  col = "gray74", border = "white", xlim = c(0.68,0.91), 
